...
public class Item {
	...
	public static int capes[] = { 2731, 2677, 2683, 2680, 2701, 2686, 2689,
			...
			4409, 4411, 4413, 4514, 4516, 6070, 6568, 6570, 5607 };
	...
	public static int gloves[] = { 7595, 6629, 8021, 8016, 7964, 2491, 1065,
			...
			7454, 7455, 7456, 7457, 7458, 7459, 7460, 7461, 7462, 6330, 3391, 7537,
			10725 };
	...
	public static int hats[] = { 10548, 2679, 2685, 2682, 2703, 2688, 2691,
			...
			7327, 7003, 15019, 13864, 13876, 10728, 11847 };
	...
	public static int body[] = { 7608, 2520, 430, 7362, 7364, 636, 638, 640,
			...
			5032, 5034, 7392, 546, 15017, 15004, 10727 };
	...
	public static int legs[] = { 7609, 2522, 7378, 7380, 7382, 7368, 7366,
			...
			3387, 5036, 5038, 5040, 15018, 15005, 13861, 13873, 10726 };
	...
	public static int platebody[] = { 11020, 10551, 10338, 7608, 2520, 430,
			...
			75, 7399, 7390, 5575, 6341, 6351, 3387, 5030, 5032, 5034, 7392, 15017, 15004, 13858, 13870,
			10727 };
	...
	private static String[] fullbody = { "wings", "Spined body", "plate",
			...
			"hauberk", "Dragon chainbody", "Vesta's Chainbody", "Statius's Platebody", "Zuriel's robe top", "Morrigan's leather body"};
	...
	private static String[] fullhat = { "helmet", "mage hat", "med helm",
			...
			"Archer helm", "Farseer helm", "Warrior helm", "Void", "Morrigan's coif", };
	...
	private static String[] fullmask = { "helm (t)", "full helm(g)", "full",
			...
			"sallet", "Statius's Full Helm", "Zuriel's hood" };
		...
		try {
			...
			while ((c = dataIn.read()) != -1) {
				if (c == 0) {
					...
					itemStackable[9977] = true;
					itemStackable[9976] = true;
					itemStackable[12225] = true;
					itemStackable[12162] = true;
