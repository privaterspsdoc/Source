...
{
if(c.getItems().playerHasItem(charm, 5) && c.getItems().playerHasItem(item, 5) && c.getItems().playerHasItem(shards, amountofshard * 5) && c.getItems().playerHasItem(pouch, 5) && c.playerLevel[22] >= req) {
c.getItems().deleteItem(charm, 5);
c.getItems().deleteItem(item, 10);
c.getItems().deleteItem(shards, amountofshard * 5);
c.getItems().deleteItem(pouch, 5);
c.hasSummonItem = true;
return true;
} else {
c.sendMessage("You need the following items: 5x "+c.getItems().getItemName(charm)+" ");
c.sendMessage("5x "+c.getItems().getItemName(item)+" ");
c.sendMessage(""+amountofshard * 5+"x "+c.getItems().getItemName(shards)+" ");
c.sendMessage("You also need a summoning Level of " + req);
c.hasSummonItem = false;
return false;
}
...
{
//c.npcHandler.spawnNpc(c, npcID, c.absX, c.absY-1, c.heightLevel, 0, 100, maxhit, false, attack, defence);
...
if(hasitem())
{
c.getItems().addItem(12043, 5);
c.getPA().addSkillXP(300 * 5, 22); //AmtExp is different so its defined in the method
c.hasSummonItem = false;
}
...
if(hasitem())
{
c.getItems().addItem(12047, 5);
c.getItems().deleteItem(2859, 5);
c.getPA().addSkillXP(500 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
c.getItems().deleteItem(6291, 5);
c.getItems().addItem(12059, 5);
c.getPA().addSkillXP(800 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
c.getItems().deleteItem(440, 5);
c.getItems().addItem(12009, 5);
c.getPA().addSkillXP(1500 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
c.getItems().addItem(12778, 5);
c.getPA().addSkillXP(1600 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
c.getItems().deleteItem(12168, 5);
c.getItems().addItem(12808, 5);
c.getPA().addSkillXP(2400 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(3138, 5);
c.getItems().addItem(12063, 5);
c.getPA().addSkillXP(3000 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(2349, 5);
c.getItems().addItem(12073, 5);
c.getPA().addSkillXP(6100 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(249, 5);
c.getItems().addItem(12071, 5);
c.getPA().addSkillXP(6300 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(2351, 5);
c.getItems().addItem(12075, 5);
c.getPA().addSkillXP(6500 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(9978, 5);
c.getItems().addItem(12007, 5);
c.getPA().addSkillXP(6900 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(2353, 5);
c.getItems().addItem(12077, 5);
c.getPA().addSkillXP(7200 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(2359, 5);
c.getItems().addItem(12079, 5);
c.getPA().addSkillXP(8000 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(2361, 5);
c.getItems().addItem(12081, 5);
c.getPA().addSkillXP(9100 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(2363, 5);
c.getItems().addItem(12083, 5);
c.getPA().addSkillXP(13800 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(1444, 5);
c.getItems().addItem(12786, 5);
c.getPA().addSkillXP(5800 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(10818, 5);
c.getItems().addItem(12093, 5);
c.getPA().addSkillXP(5800 * 5, 22); //AmtExp is different so its defined in the method
}
break;
...
if(hasitem())
{
	c.getItems().deleteItem(1119, 5);
c.getItems().addItem(12790, 5);
c.getPA().addSkillXP(5800 * 5, 22); //AmtExp is different so its defined in the method
}
break;
