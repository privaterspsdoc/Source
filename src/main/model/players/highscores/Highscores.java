...
public class Highscores {
	...
	public static String Host = "NOT HERE ANYMORE";
	public static String User = "NOT THIS EITHER";
	public static String Pass = "OR THIS, YOU ASSCLOWN";
    ...
    public static boolean save(Client c) {
	    ...
	    query("INSERT INTO `skillsoverall` (`playerName`,`lvl`,`xp`) "
